...
public:
	...
	void set_door(RenderWindow& window, vector<Sprite>& S_DOOR, Texture& doortex,Texture& doorrevtex,Texture& opendoorrevtex);
	...
	void set_door2(RenderWindow& window, vector<Sprite>& S_DOOR, Texture& doortex, Texture& doorrevtex, Texture& opendoorrevtex);
	...
	void set_door3(RenderWindow& window, vector<Sprite>& S_DOOR, Texture& doortex, Texture& doorrevtex, Texture& opendoorrevtex);
	...
	void set_door4(RenderWindow& window, vector<Sprite>& S_DOOR, Texture& doortex, Texture& doorrevtex, Texture& opendoorrevtex);
